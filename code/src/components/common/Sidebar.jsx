...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const linkClasses = ({ isActive }) =>
    `flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all duration-200
     ${
       isActive
         ? "bg-gradient-to-r from-indigo-500/20 to-blue-500/20 text-white shadow"
      ...
      >
        ...
        <div className="p-5 border-t border-white/10">
          ...
          <button
            ...
            className="mt-4 w-full py-2 rounded-lg bg-red-500 hover:bg-red-500/80 text-sm font-medium flex items-center justify-center gap-3 transition duration-300"
          >
            Logout
            <LogOut size={16} />
          </button>
